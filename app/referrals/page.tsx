...
export default function ReferralsPage(){
  ...
  useEffect(()=>{
    try{ setRefCode(localStorage.getItem("ref_code")||""); }catch{}
    try{
  ...
  function clearLogs(){ localStorage.removeItem("ref_logs"); setLogs([]); }
  ...
  return (
    <main className="grid" style={{gridTemplateColumns:"1fr", gap:16}}>
      <section className="card">
        ...
        <div className="sub" id="route-id-referrals">ROUTE: referrals</div>
